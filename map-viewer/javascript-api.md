...
We strongly recommend using a different web mapping framework implementing the OGC WMTS, like Leaflet or plain OpenLayers as in [these examples for the XYZ service](/visualize-data/xyz#openlayers).
:::
