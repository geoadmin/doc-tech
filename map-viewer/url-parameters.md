...
| `layers`       | The layers in use. Each layer can be configured, see [layer parameters](#layer-parameters) for details.                                                                                                                                                                                                               | See [layer parameters](#layer-parameters)                                                                         | https://map.geo.admin.ch/#/map?layers=ch.swisstopo.geologie-geophysik-geothermie;ch.ensi.zonenplan-notfallschutz-kernanlagen                         |
