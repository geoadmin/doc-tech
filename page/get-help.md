...
- For questions about a specific layer or geodata collection, please contact the data owners directly. The data owner contacts are available on geocat.ch. map.geo.admin.ch provides a link to the corresponding geocat page in each layer’s infobox. 
