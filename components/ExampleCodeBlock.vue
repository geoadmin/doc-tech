...
const highlighter: HighlighterGeneric<BundledLanguage, BundledTheme> | undefined =
    inject('highlighter')
...
async function click() {
    await copyToClipboard(activeTab.value === 'request' ? props.request : props.example)
